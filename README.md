...
<p>
This project analyzes UPI transactions (1,40,500 records) to identify fraud patterns, detect risky devices, analyze customer & merchant behaviour, and measure operational performance.
<br>
